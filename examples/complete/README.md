...
* This example is inteded to;
  - a) test the majority of functionality
  - b) provide a baseline of a VPC deployment.
...
**NOTE:** These examples are intended to be used for testing and demo purposes only, ensure you understand the module and modify the example code to suit your requirements.
