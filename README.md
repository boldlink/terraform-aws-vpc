...
## Description
This terraform module creates a stand-alone VPC not associated with other resources. To create a complete networking setup in the AWS Cloud, use this module together with other networking modules such as subnet module, IPAM, DHCP options just to name a few.
